...
{
    public static readonly string TEMPLATE_PATH = Application.dataPath + "/NetworkFrameworkBaseOnLLAPI/Editor/Network/Templates/";
    public static readonly string PACKET_GENERATE_PATH = Application.dataPath + "/NetworkFrameworkBaseOnLLAPI/Scripts/Network/Packets/";
    public static readonly string ASSEMBLER_GENERATE_PATH = Application.dataPath + "/NetworkFrameworkBaseOnLLAPI/Scripts/Network/Utilities/";
